...
class OVEncoder:
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Run inference
        last_hidden_state = torch.from_numpy(self.request(inputs, shared_memory=True, share_inputs=True, share_outputs=True)["last_hidden_state"]).to(
            self.device
        )
...
class OVDecoder:
    ...
    def forward(
        ...
        # Run inference
        self.request.start_async(inputs, shared_memory=True, share_inputs=True)
        self.request.wait()
